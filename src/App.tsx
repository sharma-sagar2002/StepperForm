...
import RFamilyInfoForm from './Components/RFamilyInfoForm';
import AddressForm from './Components/AddressForm';
import ReviewStep from './Components/ReviewStep';
import ThankYou from './Components/ThankYou';
import ProgressBar from './Components/ProgressBar';
import DocUpload from './Components/DocUpload';
import NewFamilyInfo from './Components/NewFamilyInfo';
        ...
        <FormProvider {...methods}>
            <div className='my-4'>
                ...
                <form className="w-1/2 content-center m-auto mt-4 mb-4 bg-gray-50 p-4 rounded-lg shadow-inner" onSubmit={methods.handleSubmit(onSubmit)}>
                    {step === 1 && <UserInfoForm />}
                    {/* {step === 2 && <RFamilyInfoForm/>} */}
                    {step === 2 && <NewFamilyInfo/>}

                    {step === 3 && <DocUpload />}
                    {step === 4 && <AddressForm />}
                    {step === 5 && <ReviewStep onEdit={handleEdit} />}
                    {step === 6 && <ThankYou />}
                    <div>
                        {step > 1 && step !== 6 && (
                            <button
